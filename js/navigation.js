const navItems = [
  ...
  },
  {
    ...
    href: './dashboard/accounts-and-credentials.html',
    filename: 'accounts-and-credentials.html',
  ...
  {
    label: 'Trello Boards',
    href: './dashboard/trello-boards.html',
    filename: 'trello-boards.html',
...
export function renderNavigation() {
  ...
  navItems.forEach((item) => {
    ...
    if (currentPage.toLowerCase() === item.filename.toLowerCase()) {
